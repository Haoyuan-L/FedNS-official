...
severity = 5
train_dir = './eurosatdata/train'
valid_dir = './eurosatdata/valid'
test_dir = './eurosatdata/test'
os.makedirs(train_dir, exist_ok=True)
os.makedirs(valid_dir, exist_ok=True)
os.makedirs(test_dir, exist_ok=True)
eurosat_dataset = datasets.EuroSAT(root='./eurosatdata', download=True)
...
# Normal train data
dataset_path = f'./eurosatdata/train/eurosatdata_original_none_train.pkl'
with open(dataset_path, 'wb') as file:
    pickle.dump([(np.uint8(convert_img(img)), label) for img, label in train_set], file)

# Normal valid data
dataset_path = f'./eurosatdata/valid/eurosatdata_original_none_valid.pkl'
with open(dataset_path, 'wb') as file:
    pickle.dump([(np.uint8(convert_img(img)), label) for img, label in validation_set], file)

# Normal test data
dataset_path = f'./eurosatdata/test/eurosatdata_test.pkl'
with open(dataset_path, 'wb') as file:
...
for method_name in d.keys():
    ...
    for severity in [3, 5]: # Low, medium, and high severity
        dataset_path = f'./eurosatdata/train/eurosatdata_{method_name}_{lvl[severity]}_train.pkl'
...
for method_name in d.keys():
    ...
    lvl = {3:'medium', 5:'high'}
    for severity in [3, 5]: # Low, medium, and high severity
        dataset_path = f'./eurosatdata/valid/eurosatdata_{method_name}_{lvl[severity]}_valid.pkl'
        corruption = lambda clean_img: d[method_name](clean_img, severity)
        with open(dataset_path, 'wb') as file:
