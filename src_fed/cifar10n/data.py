...
def get_data(id=0, num_clients=20, return_eval_ds=False, batch_size=64, with_cutout=False, split_fn=None, noisy_clients=None, num_workers=4, seed=0, data_dir='./cifar10_data', num_classes=10):
    ...
    if return_eval_ds:
        ...
        noise_file = torch.load('./cifar10n/CIFAR-10_human.pt')
