...
parser.add_argument("--num_rounds", default=120, type=int, help="number of federated rounds")
...
def run_experiment(num_rounds=120, num_clients=20, participation=1.0, data_split='iid', max_parallel_executions=5, timeout=1500, init_model=None, noisy_clients=None):
    ...
    def create_client(cid):
        ...
        return Client(int(cid), num_clients=args.num_clients, model_loader=network.get_network, data_loader=data.get_data, split_fn=get_split_fn(args.data_split), noisy_clients=noisy_clients)
...
def run_with_different_configs():
    ...
    np.random.seed(42)
    configs = [
#        {"num_rounds": 150, "num_clients": 20, "data_split": "iid", "noisy_clients": [], "participation": 1.0, "max_parallel_executions": 4},
#        {"num_rounds": 150, "num_clients": 20, "data_split": "noniid", "noisy_clients": [], "participation": 1.0, "max_parallel_executions": 4},
        {"num_rounds": 150, "num_clients": 20, "data_split": "iid", "noisy_clients": random.sample(range(20), 15), "participation": 1.0, "max_parallel_executions": 4},
        {"num_rounds": 150, "num_clients": 20, "data_split": "noniid", "noisy_clients": random.sample(range(20), 15), "participation": 1.0, "max_parallel_executions": 4},
    ]
